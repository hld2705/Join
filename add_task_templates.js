function renderCheckButton() {
    ...
    <svg class="check-button-svg" width="18" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect class="check-button" x="4" y="4" width="12" height="18" rx="3" stroke="#2A3647" stroke-width="2"/>
</svg>
<svg class="check-icon-assignedTo hidden" width="14" height="12" viewBox="0 0 16 12" fill="none"
